    ...
    return (
        <div className={styles.resetGame}>
            ...
            <div className={styles.buttonsContainer}>
                <button className={styles.Btn} onPointerDown={handleReplayDown} onClick={handleReplay}>
                    <img src={Replay} alt="Replay" className={styles.replayBtn}/>
                </button>
                <button className={styles.Btn} onPointerDown={handleResetDown} onClick={handleReset}>
